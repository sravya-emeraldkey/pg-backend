...
def lambda_handler(event, context):
    ...
    query_str = """
    INSERT INTO public.Stage (Stage_ID, Stage_Name, Description)
    VALUES 
    (6, 'Secondary Contact', 'The second point of contact with the lead'),
    (7, 'test Contact', 'The test point of contact with the lead'),
    (8, 'test 2 Contact', 'The test point of contact with the lead'),
    (9, 'test 3 Contact', 'The test point of contact with the lead'),
    (10, 'test 4 Contact', 'The test point of contact with the lead');
    """
    try:
